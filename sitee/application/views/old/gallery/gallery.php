       ...
       <input class="star-rating__input" id="<?php echo $result->p_id ?>-5" onclick="rate(<?php echo $result->p_id?>,5)" type="radio" name="rating-<?php echo $result->p_id?>" value="5" <?php echo $result->rating==5? 'checked': ''?>>
        ...
        <div id="custom-modal-<?php echo $result->p_id ?>" class="modal-demo">
            ...
            <div class="custom-modal-text">
            	<div class="row">
            			<div class="col-md-12">
            <img style="width: 539px;height: 518px;" src="<?php echo base_url(). 'uploads/gallery/'.$result->img  ?>" />	
           </div>
           </div>
           <div class="row">
          	<div class="col-md-12">
           	<div class="col-md-6"><p> Click to see on <a href='http://Instgram.com<?php echo $result->facebook ?>'>Facebook</a></p></div>
           	<div class="col-md-6"><p> Click to see on <a style="color: red" href='http://Instgram.com<?php echo $result->instagram ?>'>Instagram</a></p></div>
