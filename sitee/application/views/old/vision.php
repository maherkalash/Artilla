		...
		<div class="container">
			...
			<div class="new-profile section">	
				<div class="user-profile">
					...
					<div class="user">
						<h2><a href="#"><?php echo translate('vision') ?></a></h2>
						<h5>	</h5>
					</div>
                    ...
                    <form method="post" enctype="multipart/form-data" action="<?php echo base_url()?>my_profile">
                        <fieldset>
                            <div class="section seller-info">
                                <h4 <?php echo LANG() == 'ar' ? 'style="text-align: right"': '' ?>><?php echo trans('vision') ?></h4>     
                                 <div class="description-info">
									<p  <?php echo LANG() == 'ar' ? 'style="text-align: right"': '' ?>><span><?php echo trans('vision_def') ?> </span></p>
								</div>
