...
class Main extends CI_Controller {
	...
	public function sendmail()
	{
			...
			$this->form_validation->set_rules('subject',trans('subject'), 'required');
		...
		$mail = $this->auth->sendmail($email,'customer@jomran.com',$subject,$message);
	...
	exit;}*/
			...
			public function comfirmemail($userid)
				{
